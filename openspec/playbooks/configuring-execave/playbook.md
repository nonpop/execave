...
### Use Case: Default config location (`./execave.json`)
...
- **GIVEN** a file `./execave.json` with valid rules
- **WHEN** the user runs `execave -- ls`
- **THEN** the system reads configuration from `./execave.json`
...
- **GIVEN** no `./execave.json` file exists in the current directory
- **WHEN** the user runs `execave -- ls`
...
- **GIVEN** a config file at `/home/user/project/execave.json` with rule `fs:rw:/home/user/project/execave.json`
- **WHEN** the user runs `execave --config /home/user/project/execave.json -- ls`
