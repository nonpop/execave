...
The access-log capability handles formatting, deduplication, and filtering of filesystem access entries. It transforms raw access events into structured log entries, eliminates redundant entries, and filters out infrastructure paths that are not governed by user rules.
