...
The seccomp capability generates compiled BPF syscall filter programs for use with bwrap's `--seccomp` flag, providing kernel-enforced syscall blocking as a defense-in-depth layer within the sandbox.
