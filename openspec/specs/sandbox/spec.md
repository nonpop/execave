...
The sandbox capability provides secure process isolation using bubblewrap. It enforces filesystem access controls based on configuration rules, implements a default-deny security model, and ensures sandboxed processes can only access explicitly permitted resources.
